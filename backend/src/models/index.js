...
const userSchema=new Schema({
  ...
  role:{type:String,enum:['participant','admin','finance','judge','mentor','volunteer'],default:'participant'},permissions:[String],phone:String,college:String,department:String,course:String,semester:String,enrollmentId:String,photo:String,github:String,linkedin:String,portfolio:String,skills:[String],bio:String,
...
const hackathonSchema=new Schema({
  ...
  registrationFee:{type:Number,default:0},upiId:String,upiName:String,upiQrUrl:String,teamMin:{type:Number,default:3},teamMax:{type:Number,default:5},
